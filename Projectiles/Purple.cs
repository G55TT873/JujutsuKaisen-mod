    ...
    public class Purple : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                {
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<PurpleDust>(), Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f, 0, default(Color), 1f);
                }
            }
        }
